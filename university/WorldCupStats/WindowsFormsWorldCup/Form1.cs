    ...
    public partial class MainForm : Form
    {
        ...
        public async void run()
        {
            ...
            try
            {
                ...
                form2.first = false;
                fifa_id = await HttpClient.GetCountryCode(config[1]);
        ...
        {
            List<string> players = await Task.Run(()=> HttpClient.GetMatchFirstEleven("300331550","JPN"));
            System.Diagnostics.Debug.WriteLine("Starting eleven from japan: ");
        ...
        {
            showLoading();
            List<string> countries = await Task.Run(() => HttpClient.GetCountryNames());
            showTeamChooser();
            hideLoading();
        ...
        {
            string fifa_code = await Task.Run(() => HttpClient.GetCountryCode(cb_teamChooser.Text));
