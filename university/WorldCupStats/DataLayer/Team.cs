...
namespace DataLayer
{
    public class Team
    {
        ...
        public async Task SetUp() {
            dynamic response = await HttpClient.GetCountryMatches(teamCode);
            ...
            try {
                ...
                System.Diagnostics.Debug.WriteLine("API error.");
            }

            dynamic results = await HttpClient.GetCountryResults(teamName);
