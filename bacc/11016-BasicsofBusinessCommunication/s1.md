- [1. UČINKOVITA POSLOVNA KOMUNIKACIJA KAO ČIMBENIK NAPRETKA I (poslovne) USPJEŠNOSTI](#1-u%C4%8Dinkovita-poslovna-komunikacija-kao-%C4%8Dimbenik-napretka-i-poslovne-uspje%C5%A1nosti)
...
### Navedite koje čimbenike valja uzeti u obzir pri odabiru najprikladnijeg medija za prenošenje poruke –  
...
Postavljajte samo relevantna pitanja. Kako biste ubrzali odgovor na svoj zahtjev, postavljajte samo ona pitanja koja su bitna za vas glavni zahtjev. Tako će odgovor stići ranije i bolje ćete iskoristiti vrijeme druge osobe. 
...
#### Kada morate nešto saznati, dobiti nečije mišljenje ili zatražiti jednostavnu akciju, obično morate samo pitati. Što jednostavni zahtjevi navode? 
...
B.Odbijanje kandidata za posao 
...
#### Kako započinje negativna poruka koja upotrebljava direktan pristup? 
...
#### Dok primjenjujete proces pisanja u tri koraka na negativne poruke, imajte na umu tri važna aspekta. Navedite ih. 
...
Dajte sebi dovoljno vremena za planiranje i odgovaranje. Velika je vjerojatnost da ćete biti obasuti prigovorima, pitanjima ili povratima proizvoda nakon što objavite svoju vijest, stoga svakako pripremite odgovore i dodatne naknadne informacije. 
...
#### Slanje negativnih poruka - kao i njihovo primanje - često vodi odgađanju, omalovažavanju i iskrivljavanju loše vijesti. Kako možemo nazvati takvo postupanje? 
...
#### Uvjeravajuće poruke često dolaze nepozvane, a nekad su i nepoželjne, stoga je presudno usvajanje „ti“ stava u pisanju. Većina ljudi neće uopće niti obratiti pozornost na vašu poruku, a kamoli odgovoriti, ako ih se ona direktno ne tiče. Kako možete utjecati da prijem poruke bude srdačniji? 
...
#### Kao što je ranije naznačeno, većina uvjeravajućih poruka koristi neizravan pristup. Stručnjaci za uvjeravajuću komunikaciju razvili su brojne modele za takve poruke. Navedite jedan od najpoznatijih modela. 
...
### PLANIRANJE, PISANJE I DOVRŠAVANJE IZVJEŠTAJA I PRIJEDLOGA 
Ciljevi učenja: 
...
Ukoliko sami pripremate plan rada, on može biti relativno neformalan: jednostavan popis koraka koje planirate napraviti i procjena njihovog redoslijeda i vremenskog rasporeda. Međutim, za kompliciranije projekte, osobito one koji uključuju nekoliko članova tima, trebat će pripremiti služben i detaljan plan rada koji može usmjeravati obavljanje mnogih zadataka tijekom duljeg vremenskog razdoblja. Za konzultante i druge, čiji rad rezultira službenim izvještajem, plan rada može postati i temelj za ugovor ukoliko je prijedlog prihvaćen. Službeni plan rada može uključivati sljedeće elemente (osobito prva dva): 
    ...
    Izjava o problemu ili prilici. Izjava o problemu razjašnjava izazove s kojima se suočavate, pomaže vam (i drugima koji rade s vama) da ostanete usredotočeni na sržna pitanja i svima olakšava izbjegavanje smetnji koje će se vjerojatno pojaviti putem. 
...
12. Neka priroda onoga što opisujete diktira strukturu vašeg teksta. Informativni izvještaji koriste predmetnu organizaciju, razmještaj materijala u skladu s jednim predmeta. Navedite ih. 
    ...
    Prostorna orijentacija. Ukoliko objašnjavate kako fizički objekti rade ili kako fizički prostor izgleda, opišite ga s lijeva na desno (ili s desna na lijevo, u nekim kulturama), od vrha prema dnu, od vanjštine prema unutrašnjosti - odnosno kojim god redom ima smisla; samo budite dosljedni. 
...
13. Najvažniji izvještaj koji ćete ikada dobiti priliku pisati je poslovni plan za novi poslovni pothvat. Službeniji plan, koji je apsolutno nužan kada želite uvjeriti druge ljude da ulože ili da se pridruže vašoj organizaciji, trebao bi pokriti određene točke. Navedite ih. 
    ...
    Financijska predviđanja i zahtjevi. Uključite detaljan proračun početnih i operativnih troškova, kao i projekcije prihoda, troškova i tijekova novca za prvih nekoliko godina poslovanja. Identificirajte financijske potrebe kompanije, kao i potencijalne izvore, ukoliko je prikladno. 
...
4. Kako bi minimalizirale potencijalne probleme, mnoge suvremene kompanije donose pravilnike koji reguliraju uporabu e-maila. Što sadrže rečeni pravilnici? 
...
Naravno, tehnologija uvijek sa sobom donosi probleme. Potencijalni nedostaci IM-a uključuju sigurnosne probleme (kompjutorski virusi, probijanje mreže i opasnost da osjetljive poruke presretnu stranci), potrebu za autorizacijom korisnika (potvrda da su online korespondenti stvarno oni koji bi trebali biti), primamljivost skupljanja poruka u arhivu radi kasnijeg pregleda, nekompatibilnost između konkurentnih IM sustava i spim (neželjene komercijalne poruke, slične e-mail spamu). Srećom, rastom poduzetničkog dopisivanja u realnom vremenu (engl. enterprise instant messaging, HIM), ili IM sustava dizajniranih za široku korporativnu uporabu, mnogi od ovih problema su riješeni. Međutim, sigurnost ostaje značajna preokupacija korporativnih IM sustava. 

19. Iako se trenutačne poruke često smišljaju, pišu i šalju u roku od nekoliko sekundi, načela procesa pisanja u tri koraka i dalje su primjenjiva. Navedite ih. 

    Planiranje poruka za dopisivanje u realnom vremenu. Svaku IM razmjenu promatrajte kao razgovor; iako vjerojatno nećete svjesno planirati svaku pojedinačnu izjavu ili postavljano pitanje, odvojite malo vremena da isplanirate cjelokupnu razmjenu poruka. Ako nešto tražite, razmislite točno o onome što trebate i o najučinkovitijem načinu da to zatražite. Ako netko od vas nešto traži, prije no što odgovorite razmotrite potrebe te osobe, kao i svoju mogućnost da ih ispunite. I, iako rijetko organizirate trenutačne poruke u smislu stvaranja skice, pokusajte informaciju dostaviti na koherentan i kompletan način koji minimalizira ukupan broj potrebnih pojedinačnih poruka. 

    Pisanje poruka za dopisivanje u realnom vremenu. Kao i kod e-maila, prikladan stil pisanja poslovnih IM-a službeniji je nego stil na koji ste možda navikli u korištenju osobnih IM-a ili tekstualnih poruka. Općenito biste trebali izbjegavati IM akronime (kao što je FWIW za ,,for what it's worth" ili HTH za ,,hope that helps") osim u slučaevima kada komunicirate s bliskim kolegama. U IM razmjeni sudionici komuniciraju brzo i prilično neformalno, ali pritom zadržavaju pravila konvencionalnog ponašanja i profesionalan ton. Ovaj stil je još važniji ako vi ili vaše osoblje koristite IM u komunikaciji s klijentima i drugom izvanjskom publikom. 

    Dovršavanje poruka za dopisivanje u realnom vremenu. Jedna od najprivlačnijih stvari kod IM-a je jednostavnost koraka dovršavanja. Ne morate stvoriti poruku u uobičajenom smislu te se ona distribuira jednostavnim klikom na gumb ,,Send". Međutim, nemojte preskakati zadatke revidiranja i korigiranja. Brzo pregledajte svaku poruku prije slanja kako biste se uvjerili da u njoj ne nedostaju riječi, da su one ispravno napisane i da je poruka jasna i kompletna. 

 

20. Kako biste IM učinkovito upotrebljavali, imajte na umu nekoliko biheviorističkih spoznaja. 

Kako biste IM učinkovito upotrebljavali, imajte na umu nekoliko biheviorističkih spoznaja: potencijalno stalno prekidanje, jednostavnost slučajnog miješanja osobnih i poslovnih poruka, rizik ispadanja iz toka (ako se razvije vruća diskusija ili se zakaže iznenadan sastanak u trenutku kada niste za svojim osobnim računalom ili drugim IM uređajem) te ,,ogroman potencijal za ogroman gubitak vremena" (riječima ekonomista rada s MIT-a, Davida Autora). Povrh svega toga, ljudi su prepušteni na milost i nemilost tuđe sposobnosti tipkanja, što IM može učiniti očajno sporim. 

21. Neovisno o sustavu koji koristite, IM možete učiniti učinkovitijim i efektivnijim slijedeći određene smjernice. Navedite ih. 

    Osim ako je zakazan sastanak, postanite nedostupni onda kada se morate usredotočiti na svoj posao. 

    Ako niste u sigurnom sustavu, nemojte slati povjerljive informacije. 

    Budite iznimno oprezni pri slanju osobnih informacija - one se znaju pojaviti na računalima drugih ljudi u nezgodnom trenutku.  

    Nemojte koristiti IM za važne, ali iznenadne sastanke, ako niste sigurni da su dostupni svi oni koji bi trebali sudjelovati. 

    Nemojte koristiti IM za dugačke i kompleksne poruke, osim ako ih vaš sustav podržava; za takve poruke prikladniji je e-mail.  

    Pokušajte izbjegavati vođenje nekoliko istovremenih razgovora preko IM-a kako bite si smanjili mogućnost slanja poruke krivom primatelju i kako vaš sugovornik ne bi čekao dok vi sudjelujete u drugom razgovoru. 

    Slijedite sve sigurnosne smjernice koje su osmišljene da kompanijine informacije i sustave osiguraju od napada. 

 

22. Vezano za produktivnu upotrebu IM-a, na koje posebnosti trebate obratiti pozornost? 

 

 

KONTROLNA LISTA: Produktivna upotreba IM-a 

 

 

    Obratite pozornost na pitanja sigurnosti i privatnosti, te svakako slijedite smjernice kompanije.  

    Tretirajte IM kao profesionalni komunikacijski medij, a ne kao neformalni, osobni alat; izbjegavajte korištenje IM slenga sa svi ma osim s bliskim kolegama. 

    Slijedite pravila dobrog ponašanja, čak i tijekom jednostavnih razmjena. 

    Zaštitite vlastitu produktivnost tako da postanete nedostupni kada se morate usredotočiti. 

    U većini slučajeva, ne koristite IM za povjerljive, kompleksne i osobne poruke. 

 

 

23. O čemu ovisi izbor opreme koja je potrebna za snimanje podcasta? 

Oprema koja je potrebna za snimanje podcasta ovisi o stupnju produkcijske kvalitete koji želite postići. Za najjednostavnije podcastove, poput onih koje možda snimate za internu publiku, većina suvremenih računala vjerojatno ima opremu koja vam je potrebna: jeftin mikrofon (većina prijenosnih računala ima ugrađen mikrofon), zvučna kartica koja pretvara signal iz mikrofona u digitalni format (većina kompjutora ih ima) i softver za snimanje (besplatne verzije su dostupne online). Mnogi digitalni diktafoni također mogu snimati audio-datoteke koje možete prenijeti na osobno računalo i urediti ih i distribuirati. 

24. Navedite (opišite) shemu stvaranja podcasta.  

Stvaranje podcasta zahtijeva samo nekoliko jednostavnih koraka, a najosnovniji podcastovi mogu se napraviti upotrebom besplatnog ili jeftinog hardvera i softvera. 

 

Shema stvaranja podcasta 

 

 

25. Što je važno „imati na umu“ vezano za planiranje i stvaranje poslovnih podcastova? 

 

 

KONTROLNA LISTA: Planiranje i stvaranje poslovnih podcastova 

 

 

    Razmotrite upotrebu podcasta kad god imate priliku da zamijenite postojeće audio-poruke i video-poruke. 

    Ukoliko planirate napraviti podcast kanal s regularnim priljevom novog sadržaja, svakako odredite temu ili svrhu koja je dovoljno bogata da vam pruži materijal za nastavak rada.  

    Osobitu pozornost obratite na najave, prijelaze i preglede kako se vaša publika ne bi izgubila. 

    Odlučite želite li improvizirati svoj podcast ili govoriti i snimati s unaprijed pripremljenim scenarijem. 

    Ako improvizirate, planirajte i organizirajte kako ne biste pravili greške i lutali tražeći poantu.  

    Zapamtite da je prepravljanje puno teže s audio i video zapisima nego s tekstualnim medijima, stoga pažljivo isplanirajte sadržaj i snimanje. 

    Razmotrite povezivanje svog podcasta s blogom kako biste pružili dodatne informacije i imali forum za povratne informacije od publike. 

    Ako je to prikladno, objavite svoj podcast putem RSS-a. 
...
26. Navedite  šest smjernica za stvaranje uspješnog sadržaja u društvenim medijima. 

 

    Zapamtite da je to razgovor, a ne predavanje ili prodaja. Jedan od razloga privlačnosti društvenih medija je osjećaj konverzacije. Ljudi razgovaraju jedni s drugima umjesto jedne osobe koja govori svima drugima. Kompanije koje pokušavaju zadržati stari mentalni sklop ,,mi govorimo, ti slušaš" vjerojatno će biti ignorirane na pozornici društvenih medija. 

    Pišite neformalno, ali ne i nemarno. Pišite kao ljudska bića, a ne kao kotačići u korporativnom stroju. Istovremeno, nemojte postati nemarni; nitko se ne želi mučiti s krivo napisanim riječima i nedorečenim rečenicama dok traži poruku.  

    Stvarajte jezgrovite, određene i informativne naslove. Oduprite se iskušenju pametnih igri riječi s naslovima. Naravno, ovaj savjet vrijedi za sve oblike poslovne komunikacije, ali on je ključan za društvene medije. Čitatelji, osobito oni koji bi potencijalno mogli proširiti vaše ime i ideje diljem weba, ne žele trošiti vrijeme i energiju koji su potrebni za odgonetanje značenja vaših dosjetljivih naslova.  

    Uključite se i ostanite uključeni. Razumljivo je da društveni mediji čine neke poslovne ljude nervoznima jer oni ne omogućavaju visoku razinu kontrole nad porukom. Kompanije i pojedinačni rukovoditelji mogu biti i bivaju stalno kritizirani u društvenim medijima. Međutim, nemojte se skrivati od kriticizma. Iskoristite priliku da ispravite dezinformacije ili objasnite kako će se pogreške ispraviti. 

    Ako morate nešto promovirati, učinite to diskretno. Jednako kao što ne biste napali ljude kompanijinim sloganom za prodaju tijekom neformalnog društvenog okupljanja, suzdržite se od napadnih promotivnih pokušaja u društvenim medijima. Na primjer, umjesto da navodite karakteristike kojima inače reklamirate proizvod, ispričajte priču o tome kako je proizvod promijenio nečiji život. 

    Budite otvoreni i pošteni. Poštenje je, naravno, uvijek ključno, ali mnoge su kompanije posljednjih godina posrnule zbog skrivanja iza online blog osobnosti - bilo da je riječ o fiktivnoj osobi umjesto koje je zapravo pisala korporacija ili je riječ o stvarnoj osobi koja prikriva povezanost s korporativnim sponzorom. 

 

 

27. U mjeri u kojoj to vjerojatno nije moguće s niti jednim drugim medijem, blogovi mogu doprijeti do velike i široko rasprostranjene publike. Dobri blogovi stvoreni su uz uvažavanje nekoliko važnih elemenata. Navedite ih. 

    Komuniciranje osobnim stilom i autentičnim glasom. Većina poslovnih poruka koje su namijenjene širokoj publici pažljivo su osmišljene i napisane impersonalnim i objektivnim ,,korporativnim glasom". Suprotno tome, uspješne poslovne blogove poput South Airlinesovog, pišu pojedinci, pa ti blogovi odražavaju njihov osobni stil. Publika reagira na ovaj novi pristup, a to često rezultira uspostavljanjem jače emocionalne povezanosti s blogerovom organizacijom. 

    Brzo dostavljanje novih informacija. Današnji alati za blogiranje omogućavaju vam da u nekoliko minuta objavite novi materijal koji ste upravo napisali ili snimili. Ne samo da vam ova mogućnost daje priliku da odgovorite brzo onda kada je to potrebno - na primjer, u vrijeme korporativne krize - već također vašoj publici daje do znanja da sudjeluje u aktivnom razgovoru. Blogovi koji ne nude kontinuiran tijek novog i interesantnog sadržaja u današnjem se online okružju brzo ignoriraju. Također, teme ne moraju biti ekskluzivne ili najnovije vijesti, dovoljno je da budu nešto za što ljudi mare i za što su spremni provesti vrijeme u čitanju. Na primjer, Harold Baker, istraživač iz Cloroxa, na blogu piše pod imenom ,,Doktor za pranje rublja" (Dr. Laundry) i daje korisne savjete o uklanjanju mrlja i obavljanju drugih kućanskih poslova. 

    Odabiranje tema od ključnog interesa za publiku. Uspješni blogovi pokrivaju teme za koje čitatelji mare. Popularni blog General Motorsa (http://fastlane.gmblogs.com) predstavlja glavne rukovoditelje koji pišu o automobilima GM-a te odgovaraju na pitanja i kritike automobilskih entuzijasta. Ljudi koji čitaju blog i pišu komentare očito vole automobile i žele najnovije informacije od GM-a. 

    Ohrabrivanje publike da se priključi razgovoru. Ne pozivaju svi blogovi na komentare, iako većina to ipak čini. Ti komentari mogu biti dragocjen izvor vijesti, informacija i uvida. Osim toga, čini se da relativno neformalna priroda blogiranja olakšava predstavnicima kompanija da se opuste i razgovaraju s publikom. Naravno, nisu svi komentari korisni niti prikladni, stoga mnogi blogeri pregledavaju sve komentare i objavljuju one koji su najkorisniji ili najzanimljiviji. 

 

28. Blogovi su potencijalno rješenje kad god imate stalan tijek informacija koje želite dijeliti s online publikom - a osobito kad želite publici dati priliku da odgovori. Navedite načine kako tvrtke koriste blogove? 

    Upravljanje projektima i timska komunikacija. Upotreba bloga dobar je način da projektni timovi ostanu u toku, osobito kada su pojedini članovi tima geografski udaljeni. Na primjer, izvještaji s putovanja koje zaposlenici ispunjavaju nakon posjeta klijentu ili drugim eksternim strankama mogu se znatno poboljšati upotrebom mobilnih blogova ili moblogova. Zahvaljujući praktičnim mobilnim telefonima i drugim bežičnim multimedijalnim uređajima s kamerama, zaposlenici na putu mogu slati tekst, slike, audio-zapise i video-zapise svojim kolegama. Nasuprot tome, mobilni zaposlenici također mogu biti u kontaktu sa svojim timskim blogovima upotrebom dlanovnika. 

    Kompanijske vijesti. Kompanije mogu koristiti blogove da bi svoje zaposlenike informirale o općenitim poslovnim stvarima, od vijesti o uredskoj opremi do obavijesti o pogodnostima. Blogovi također služe kao forumi online zajednice. Putem opcije za komentiranje svima u kompaniji daju priliku da postave pitanja i iskažu svoje preokupacije. 

    Podrška klijentima. Nastavljajući se na tradiciju foruma za online podršku klijentima, koji su postojali od najranijih dana Interneta, blogovi za podršku daju odgovore na pitanja, nude smjernice i savjete te informiraju kupce o novim proizvodima. 

    Odnosi s javnošću i s medijima. Mnogi zaposlenici kompanije, pa čak i visoko pozicionirani rukovodioci, sada putem svojih blogova dijele kompanijske vijesti sa zainteresiranom javnošću i s novinarima. Izvrstan primjer za to je blog Nuts About Southwest koji je predstavljen na početku ovog poglavlja. 

    Regrutiranje. Upotreba bloga sjajan je način da potencijalni zaposlenici saznaju više o vašoj kompaniji, ljudima koji u njoj rade i o kulturi kompanije. 

    Rasprava o pravilniku i spornim pitanjima. Blogovi rukovoditelja sve više postaju mjesto javne diskusije o pravu, regulativama i drugim širokim pitanjima koja se tiču organizacije. 

    Krizna komunikacija. Upotreba bloga predstavlja efikasan način da pružite najnovije informacije tijekom kriza, da ispravite dezinformacije ili odgovorite na glasine.  

    Istraživanje tržišta. Blogovi mogu biti koristan mehanizam za prikupljanje povratnih informacija od kupaca i stručnjaka na tržištu. Osim korištenja njihovih vlastitih blogova za istraživanje, današnje kompanije moraju pratiti blogove koji će vjerojatno pričati o njima, njihovim rukovoditeljima i proizvodima. Negativne recenzije proizvoda, glasine i druge informacije mogu se u nekoliko sati proširiti svijetom, stoga menadžeri moraju biti svjesni onoga što online zajednica govori - bilo da je to pozitivno ili negativno. Analitičari reputacije kao što je Evolve24 (www.evolve24.com) razvili su načine da automatski prate blogove i druge online izvore kako bi vidjeli što ljudi govore o njihovim korporativnim klijetima te da bi procijenili rizike i prilike unutar online konverzacije. 

    Brainstorming. Online brainstorming putem blogova ljudima pruža priliku da razmjenjuju ideje i da se međusobno nadopunjuju. 

    Viralni marketing. Blogosfera je isprepletena vezama i to je čini prirodnim sredstvom za širenje imena kompanije i njezinih proizvoda. Blogeri često pišu članke u kojima stavljaju poveznice za druge blogove i web stranice koje ih interesiraju te tako daju marketinškim stručnjacima priliku da prošire svoju poruku. Viralni marketing je prijenos poruke koja se širi na sličan način na koji se virusi prenose s čovjeka na čovjeka. 

    Zamjena za e-mail. S obzirom da je zbog spam filtara postalo nešto teže doprijeti do ljudi putem e-maila, mnoge su se kompanije okrenule blogovima kako bi klijentima i drugoj publici distribuirale informacije. 

    Objavljivanje vijesti (syndication). Blogiranje omogućava pojedincima i kompanijama da postanu izdavači vijesti i drugih informacija.  

    Izgradnja zajednice. Blogiranje je izvrstan način povezivanja ljudi sa sličnim interesima.  

    Mikroblogiranje, čiji je najpoznatiji predstavnik Twitter (http://twitter.com), je blogiranje manjeg opsega upotrebom računala, IM-a ili mobilnog telefona. Starbucks, Whole Foods Markets, The Home Depot i Comcast spadaju u sve veći broj kompanija koje koriste Twitter kako bi izgradile zajednice entuzijasta koji sudjeluju u istraživačkim studijama ili drugim razgovorima, ili pak zajednice ljudi koji jednostavno žele pratiti novosti i događaje koji se tiču njihovih najdražih proizvoda ili kompanija. 

 

Mogućnosti bloga gotovo su neograničene, stoga pozorno pratite nove načine da ih koristite kako biste održali pozitivne odnose s kolegama, kupcima i drugom važnom publikom. 

 

29. Objasnite ovaj naputak o blogiranju: „Pišite autentičnim glasom, nikada ne stvarajte umjetnu osobu koja navodno piše blog“. 

 Flogovi ili lažni blogovi (engl.fake blogs) narušavaju duh blogiranja, pokazuju nepoštovanje prema publici te mogu publiku okrenuti protiv autora čim se otkrije istina. 

30. Objasnite ovaj naputak o blogiranju: „Uzmite si vremena da napišete uvjerljive i precizne naslove za svoje članke“. 

Čitatelji obično u nekoliko sekundi odluče hoće li čitati vaše članke; dosadni ili nejasni naslovi odmah će ih odbiti. 

 

31. Objasnite ovaj naputak o blogiranju: „Postavljajte poveznice velikodušno - ali oprezno“. 

Postavljanje zanimljivih poveznica prema drugim blogovima ili web stranicama temeljni je aspekt blogiranja, ali neka poveznice budu od koristi vašim čitateljima i ne povezujte prema neprikladnom sadržaju. 

 

8. DIZAJNIRANJE VIZUALNE KOMUNIKACIJE 

 

1. Argumentirano pojasnite ovu rečenicu: „Dobro dizajnirani vizualni elementi mogu uvećati komunikacijsku moć tekstualnih poruka i, u nekim slučajevima, čak i zamijeniti tekstualne poruke.  

Vizualni elementi često mogu prenijeti neke teze poruke (kao što su prostorni odnosi, korelacije, procedure i emocije) djelotvornije i efektnije od riječi. Općenito govoreći, u određenom vremenu, dobro dizajnirane slike mogu prenijeti više informacija od teksta. U svijetu rada orijentiranom na brojeve ljudi se uvelike oslanjaju na linije trendova, distribucijske krivulje i vizualne prezentacije numeričkih kvantiteta. Vizualni elementi privlače i zadržavaju pažnju ljudi i pomažu vašoj publici da shvati i upamti vašu poruku. Zaposleni čitatelji često prelaze na vizualne elemente kako bi pokušali shvatiti bit poruke, a atraktivni vizualni elementi često mogu čitateljima dodatno pojasniti vaše izvještaje i prezentacije. Korištenje slike također je učinkovit način komuniciranja s raznolikom publikom koja je uobičajena u današnjem poslovnom okružju. 

2. Prenose li vizualni elementi (ponekad) i konotativna značenja 

Osim svoje izravne informacijske vrijednosti, vizualni elementi često prenose i konotativna značenja.  

3. Argumentirano pojasnite ovu rečenicu. Mnoge riječi i izrazi nose konotativna  značenja, odnosno mentalne slike, emocije i druge utiske koje riječi i izrazi bude u članovima publike.  

Značajan dio moći - i rizika - vizualnih elemenata proizlazi iz njihovih konotativnih značenja. Čak i nešto jednostavno poput simbola na vodenom žigu koji je ugrađen u zaglavlje pisma može povećati čitateljevo povjerenje u poruku koja je ispisana na papiru. Mnoge boje, oblici i drugi dizajnerski elementi imaju vizualnu simboliku, a njihovo simbolično. konotativno značenje može evoluirati tijekom vremena i značiti različite stvari u različitim kulturama. Svijest o ovim simboličkim značenjima i njihovo upotrebljavanje na vlastitu korist važna je osobina učinkovitog poslovnog komunikatora. 

 

4. Argumentirano pojasnite ovu rečenicu: Budući da imaju toliku moć u komunikaciji, vizualni elementi moraju se pažljivo planirati, kompetentno izraditi i neprimjetno integrirati u tekst.  

Nespretna rečenica ili gramatička pogreška duboko u izvještaju možda će proći neprimijećena kod većine čitatelja, ali loše odabran ili nespretno implementiran vizualni element većina će čitatelja primijetiti - a on može zbuniti ili udaljiti vašu publiku i naškoditi vašem kredibilitetu. Ne morate biti profesionalan dizajner da biste učinkovito upotrebljavali vizualne elemente, ali morate biti svjesni osnovnih načela dizajna ukoliko želite izbjeći uočljive pogreške.  

 

5. Argumentirano pojasnite ovu rečenicu (tvrdnju): Nekoliko tehnoloških i društvenih čimbenika doprinosi povećanoj upotrebi - i važnosti - vizualnih elemenata u poslovnoj komunikaciji.  

Proces stvaranja i rada s vizualnim elementima nekada je bilo područje stručnjaka s kompleksnim i skupim alatima. Međutim, digitalna tehnologija dramatično je promijenila ovu situaciju. Digitalne kamere mogu stvarati visokokvalitetne slike i videozapise, jeftine su i dovoljno jednostavne da ih svatko može koristiti, a softver potreban za stvaranje dijagrama, obrađivanje fotografija, montiranje videozapisa i pripremanje drugih vizualnih elemenata stalno postaje sve jednostavniji i snažniji. Osim toga, globalni doseg Interneta pojednostavljuje gotovo trenutačno slanje poruka, a sve više internetskih korisnika ima vrlo brze veze koje omogućuju prijenos većih kompjutorskih dokumenata kakve vizualni elementi obično zahtijevaju. Zadaci dizajna i stvaranja, za koje su nekada bili potrebni dani, sada se mogu dovršiti u nekoliko sati, čak i minuta. Kako tehnologije poput bežičnog umrežavanja napreduju, poslovni komunikatori nastavljaju dopirati do šire publike u manje vremena, koristeći opremu koja je jeftinija i zahtijeva manje vještine 

6. Dok razmišljate o vlastitim reakcijama na različita dizajnerska rješenja i dok stvarate vlastita, počet ćete uviđati kako vam šest temeljnih načela pomaže u razlikovanju između učinkovitog i neučinkovitog dizajna. Navedite ih. 

    Konzistentnost. Publika promatra niz vizualnih elemenata kao cjelinu i pretpostavlja da će oni biti dosljedni od jedne do druge stranice. O konzistenciji razmišljajte kao o vizualnom paralelizmu, na isti način na koji tekstualni paralelizam pomaže publici da shvati i usporedi niz ideja. Vizualni paralelizam možete postići na brojne načine, uključujući konzistentnu upotrebu boja, oblika, veličine, teksture, položaja, odnosa ili tiskarskog sloga. 

    Kontrast. Da biste naglasili razlike, predmete prikažite kontrastnim bojama, oblicima ili veličinama. Na primjer, da biste istaknuli razliku između dvije veličine u kružnom grafikonu, nemojte koristiti dvije nijanse plave, umjesto toga, koristite plavu za jednu veličinu i žutu, ili neku drugu dramatično kontrastnu boju, za drugu veličinu. 

    Ravnoteža. Ravnoteža može biti formalna, kada su elementi na slikama simetrično raspoređeni oko centralne točke ili osi, ili neformalna, kada elementi nisu ravnomjerno raspoređeni, ali su jači i slabiji elementi postavljeni na način kojim se postiže ukupan efekt ravnoteže. Uobičajen je pristup neformalnoj ravnoteži suprotstavljanje jednog vizualno dominantnog elementa naspram nekoliko manjih ili slabijih elemenata. Općenito govoreći, formalna ravnoteža je smirenija i ozbiljnija, dok neformalna ravnoteža ostavlja dojam dinamičnosti i privlačnosti. 

    Isticanje. Publika obično pretpostavlja da je dominantan element dizajna najvažniji, stoga se pobrinite da vizualno dominantan element uistinu i predstavlja najvažniju informaciju. To možete učiniti, primjerice, bojom, položajem, veličinom ili smještajem. Suprotno tome, svakako smanjite vizualnu istaknutost manje važnih elemenata. Na primjer, izbjegavajte upotrebu jakih boja za manje potporne teze i smanjite naglašenost pozadinskih karakteristika kao što su rešetkaste linije na grafikonu. 

    Konvencije. Vizualna komunikacija rukovodi se brojnim općenito prihvaćenim pravilima ili konvencijama, kao što se pisana komunikacija rukovodi pravopisnim, gramatičkim, interpunkcijskim i uporabnim pravilima. Ova pravila upravljaju gotovo svakim aspektom dizajna. Štoviše, mnoga su pravila toliko ukorijenjena da ljudi nisu niti svjesni da ih se pridržavaju. Na primjer, ako je vaš materinji jezik hrvatski, vi pretpostavljate da ideje napreduju s lijeva na desno jer je to smjer kojim se u Hrvatskoj piše. Međutim, ukoliko vam je materinji jezik arapski ili hebrejski, mogli biste automatski pretpostaviti da ideje na stranici ili zaslonu teku s desna na lijevo jer se na tim jezicima piše u tom smjeru. Slično tome, japanska je publika naučena čitati časopise od kraja prema početku s desna na lijevo. Izigravanje ovih pravila često uzrokuje prekide u komunikaciji, ali u nekim slučajevima, to može biti vrlo učinkovito. Na primjer, preokretanje organizacijskog dijagrama naglavce tako da su kupci na vrhu, zaposlenici u izravnom kontaktu s njima su red ispod njih, a glavni rukovoditelj na dnu, može biti učinkovit način isticanja da kupci dolaze prvi i da je dužnost menadžera podupiranje zaposlenika u njihovim naporima da zadovolje kupce. 

    Jednostavnost. Kao općenito pravilo, jednostavno je bolje kada se radi o vizualnim elementima poslovne komunikacije. Zapamtite da prenosite informacije, a ne uređujete stan niti stvarate umjetničko djelo. Ograničite broj boja i dizajnerskih elemenata koje koristite i pazite da izbjegavate chartjunk, pojam koji je stvorio specijalist za vizualne komunikacije Edward R. Tufte i kojim je opisao dekorativne elemente koji guše dokumente i mogu zbuniti čitatelje, a da ne dodaju nikakvu relevantnu informaciju. Pomoću kompjutora je dodavanje chartjunka postalo prejednostavno, od clip art ilustracija do trodimenzionalnih dijagrama koji prikazuju samo dvije dimenzije podataka. 

7. U kontekstu dizajna, objasnite načelo Konzistentnosti. 

 

8. U kontekstu dizajna, objasnite načelo Kontrasta. 

9. U kontekstu dizajna, objasnite načelo Ravnoteže 

10. U kontekstu dizajna, objasnite načelo Isticanja. 

11. U kontekstu dizajna, objasnite načelo Konvencije. 

12. U kontekstu dizajna, objasnite načelo Jednostavnosti 

 

13. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Nabrojite ih. 

 

    Razmotrite sve moguće interpretacije - i krive interpretacije.  

    Navedite kontekst.  

    Nemojte skrivati ili umanjivati negativne informacije koje su proturječne vašim argumentima.  

    Nemojte preuveličavati informacije koje podržavaju vaš argument 

    Nemojte pretjerano pojednostavljivati kompleksne situacije 

    Nemojte implicirati kauzalne odnose bez dokaza o njihovom postojanju 

    Izbjegavajte emocionalnu manipulaciju ili druge oblike prisile 

 

14. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Pojasnite smjernicu, „Razmotrite sve moguće interpretacije - i krive interpretacije“. 

    Razmotrite sve moguće interpretacije - i krive interpretacije. Pokušajte vizualni element promotriti iz perspektive članova svoje publike. Hoće li ih njihove predrasude, vjerovanja ili iskustvo navesti na drugačije zaključke od onih koje ste vi željeli? Na primjer, pretpostavite da želite pokazati kako je jednostavno koristiti vaš proizvod, a fotografija koju ste odabrali slučajno prikazuje ženu kako rukuje proizvodom. Hoće li netko zaključiti da ste htjeli reći da je vaš proizvod toliko jednostavan da ga ,,čak i žena može koristiti"? 

 

15. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Pojasnite smjernicu, „Navedite kontekst“. 

    Navedite kontekst. Čak i kada su potpuno točni, svi vizualni elementi mogu prikazivati samo djelomičan pogled na stvarnost. Dio je vaše odgovornosti kao komunikatora pružanje ne samo točnih vizualnih elemenata, već i dovoljne količine pozadinskih informacija kako biste pomogli vašoj publici da vizualne informacije točno interpretira. 

 

16. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Pojasnite smjernicu, „Nemojte skrivati ili umanjivati negativne informacije koje su proturječne vašim argumentima“. 

    Nemojte skrivati ili umanjivati negativne informacije koje su proturječne vašim argumentima. Skrivanje informacija sprečava vašu publiku da donese potpuno informirane odluke o vašem sadržaju. 

 

 

17. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Pojasnite smjernicu, „Nemojte preuveličavati informacije koje podržavaju vaš argument“. 

    Nemojte preuveličavati informacije koje podržavaju vaš argument. Slično tome, vaša je obaveza da ne precjenjujete informacije kojima podržavate svoj argument. Također biste se trebali oduprijeti iskušenju da mijenjate ili poboljšavate fotografije i i druge slike kako biste potkrijepili svoje argumente. 

 

 

18. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Pojasnite smjernicu, „Nemojte pretjerano pojednostavljivati kompleksne situacije“.  

    Nemojte pretjerano pojednostavljivati kompleksne situacije. Po svojoj prirodi, vizualne informacije obično predstavljaju pojednostavljene poglede na stvarnost. To je obično prednost i jedan od glavnih razloga za korištenje vizualnih elemenata. Međutim, pripazite da ne zavaravate publiku skrivanjem komplikacija koje su publici važne za shvaćanje situacije. 

 

19. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Pojasnite smjernicu, „Nemojte implicirati kauzalne odnose bez dokaza o njihovom postojanju“.  

    Nemojte implicirati kauzalne odnose bez dokaza o njihovom postojanju. Na primjer, ukoliko stvorite linijski grafikon koji pokazuje kako povećanja prodaje prate povećanja u izdacima za oglašavanje, možete tvrditi da postoji korelacija, ali ne nužno i kauzalan odnos između te dvije stvari. Možete tvrditi da kauzalan odnos postoji (u značenju da je povećano oglašavanje uzrokovalo povećanu prodaju) samo ako možete izolirati izdatke) za oglašavanje kao jedini čimbenik koji je mogao uzrokovati povećanje prodaje. 

 

20. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Pojasnite smjernicu, „Izbjegavajte emocionalnu manipulaciju ili druge oblike prisile“. 

    Izbjegavajte emocionalnu manipulaciju ili druge oblike prisile. Na primjer, fotografija nesretnog djeteta prema kojemu se drugi odnose kao prema društvenom otpadniku jer nema najpopularniju novu igračku može se smatrati neetičnim načinom uvjeravanja roditelja da kupe taj proizvod za svoju djecu. 

 

21. Pridržavanjem određenih smjernica možete izbjeći etičke pogreške u vizualnim elementima. Pojasnite smjernicu, „Oprezno agregirajte podatke“. 

 

 

    Oprezno agregirajte podatke. Pripremanje dijagrama, grafikona i tablica koje prezentiraju podatke često uključuje odluke o agregiranju ili grupiranju podataka. Odluke koje donesete o agregiranju podataka mogu imati dubok efekt na poruku koju prima vaša publika. Na primjer, ukoliko agregirate dnevne razine proizvodnje kako biste pokazali samo jedan podatak za svaki tjedan, mogli biste prikrivati važne varijacije u dnevnoj proizvodnji. 

 

22. Da biste identificirali dijelove svojih poruka kojima vizualni elementi mogu koristiti, odmaknite se i promotrite tijek vaše poruke sa stajališta publike. Koji će se dijelovi poruke vjerojatno doimati kompleksnima, otvorenima za krivu interpretaciju ili čak i pomalo dosadnima? Postoje li neke veze između ideja koje možda nisu očite iz samog teksta? Postoji li mnogo numeričkih podataka ili drugih činjeničnih podataka koje bi bilo teško čitati ako  budu iznijeti u obliku odlomaka? Postoji li šansa da glavna ideja neće biti dovoljno uočljiva ako je iznesena samo u tekstu? 

Ukoliko potvrdno odgovorite na bilo koje od ovih pitanja, vjerojatno vam je potreban jedan vizualni element ili više njih. Prilikom odlučivanja o tezama koje treba vizualno predstaviti, sjetite se bitnih elemenata_točaka i navedite  ih. 

    Jasnoća. Ljudski um iznimno je uspješan u obrađivanju vizualnih informacija, bilo da je riječ o nečem jednostavnom kao što je oblik znaka stop ili kompliciranom kao što je tlocrt nove tvornice. Ukoliko vam je ideju teško izraziti riječima, razmislite o tome da je izrazite vizualnim elementima. 

    Cjelovitost. Vizualni elementi, osobito tablice, često služe za dostavljanje potpornih detalja za glavnu ideju ili preporuku. Tablica ili drugi vizualni element može predstaviti ove detalje, a da time ne ometa glavnu poruku. 

    Jezgrovitost. Vjerojatno ste čuli za izraz ,,Slika vrijedi tisuću riječi". Ukoliko vam se čini da određeni dio vaše poruke zahtijeva opširan opis ili objašnjenje, potražite način da tu informaciju vizualno prenesete. Sa slikom koja upotpunjuje tekst, možda ćete moći značajno smanjiti broj potrebnih riječi. 

    Povezanost. Ključna je svrha mnogih poslovnih poruka iskazivanje različitih vrsta veza - sličnosti ili razlika, korelacija, kauzalnih odnosa itd. Kad god želite da vaši čitatelji uoče te veze, odredite hoće li pomoći tablica, dijagram ili druga ilustracija. 

    Uvjerljivost. Hoće li jedna ili više ilustracija učiniti vašu poruku uvjerljivijom, interesantnijom, povećati vjerojatnost da bude pročitana? Naravno, nikada ne biste trebali stavljati vizualne elemente isključivo zbog dekoracije, ali čak i ako se određena teza može izraziti jednako dobro tekstom i vizualnim elementom, razmislite o dodavanju vizualnog elementa kako bi vaš izvještaj bio uvjerljiviji 

23. Da biste uspješno koristili fotografije, navedite pet bitnih smjernica. 

  

    Provjerite bi li dijagram bio učinkovitiji od fotografije. Fotografije su često najbolji način za prikazivanje prostornih odnosa, veličina, oblika i drugih fizičkih parametara, ali ponekad one prenose previše informacija. Na primjer, kod prikazivanja načina na koji se podešava određeni dio nekog kompliciranog stroja fotografija može biti previše zbunjujuća jer pokazuje sve dijelove koje kamera može uhvatiti. Pojednostavljeni dijagram često je učinkovitiji jer vam omogućuje da naglasite određene dijelove koji su relevantni za problem kojim se bavite. 

    Naučite koristiti osnovne alate za obradu slika. Na primjer, fotografije možete izravno ubaciti u svoj tekstualni ili prezentacijski dokument i zatim upotrijebiti taj program za mijenjanje veličine fotografije tako da ona ispuni raspoloživ prostor, ali to nije uvijek najbolji pristup. Umjesto jednostavnog mijenjanja veličine, možda bi bolje bilo izrezati fotografiju, odnosno odstraniti dio fotografije elektroničkim putem. 

    Prilagodite dokument aplikaciji. Digitalne fotografije značajno se razlikuju po rezoluciji odnosno količini detalja na slici. Rezolucija se može izraziti na dva načina Digitalni fotoaparati obično se specificiraju u pikselima, ukupnom broju elemenata slike u dokumentu. Na primjer, fotoaparat od 5 megapiksela stvara fotografiju s 5 mili-juna piksela na slici. Printeri i skeneri obično su specificirani u točkama po inču (engl. dots per inch) ili dpi, odnosno broju zasebnih točaka u jednom inču. Tako uredski printer od 600 dpi stvara 360 000 (600 x 600) zasebnih točaka po kvadratnom inču. Ovisno ograničenjima printera, veća rezolucija je obično bolja za tiskane dokumente, ali nije uvijek korisna za online upotrebu. Slikovni dokumenti velike rezolucije znatno su veći od dokumenata s niskom rezolucijom, stoga oni zahtijevaju više prostora za pohranu više vremena za prijenos i preuzimanje. Osim toga, mnogi kompjutorski monitori i drugi elektronički zasloni ionako ne mogu prikazati sve fine detalje slika s visokom rezolucijom (barem ne bez zumiranja i stalnog pomicanja naprijed i natrag kako bi se vidjela čitava slika). Ako planirate koristiti fotografije na web stranicama ili u online izvještaju, koristite opciju ,,spremi za web" u svom softveru za obradu fotografija kako biste smanjili rezoluciju, a time i veličinu dokumenta. 

    Uvjerite se da fotografije imaju komunikacijsku vrijednost. Osim naslovnica, početnih slideova i drugih posebnih upotreba, obično je najbolje izbjegavati fotografije samo radi njihove dekorativne vrijednosti. 

    Budite svjesni autorskih prava i dopuštenja od modela. Online fotografije, kao ni tekstualne informacije koje pronađete online, ne možete jednostavno umetnuti u svoje dokumente. Osim ako je posebno navedeno da se nude besplatno, morate pretpostavljati da netko posjeduje fotografije i da ima pravo na naknadu ili da ga se barem spomene kao izvor. Osim toga, profesionalni fotografi vode računa o tome da svi modeli na njihovim fotografijama potpišu obrazac s dopuštenjem koji fotografu daje pravo da koristi sliku te osobe. 

 

 

24. Ako morate usporediti nekoliko subjekata (kompanije, tržišta, zaposlenike itd.) s dvije varijable, kao što je prihod i profitna margina, koji dijagram ćete upotrijebiti?  

Ako morate usporediti nekoliko subjekata (kompanije, tržišta, zaposlenike itd.) s dvije varijable, kao što je prihod i profitna margina, upotrebljavajte dijagram raspršenosti poznat i kao XY dijagram. Ovaj dijagram je sličan linijskom grafikonu jer je jedna varijabla ucrtana uzduž osi x (horizontalne osi), a druga uzduž osi y (vertikalne osi). Međutim, u dijagramu raspršenosti su ucrtane pojedinačne točke, a ne neprekinute linije. Mjehuričasti dijagram uključuje do tri varijable, gdje veličina mjehurića predstavlja treću varijablu. 

25. Ukoliko umjesto numeričkih morate prikazati fizičke ili konceptualne odnose, kojim načinom ćete ih prikazati? 

Mogli biste koristiti dijagrame toka ili organizacijske dijagrame.  

 

 

26. Pojasnite Dijagram toka  

 

Ilustrira redoslijed događaja od početka do završetka; on je nezamjenjiv za ilustriranje procesa, procedura i sekvencijalnih odnosa. Za općenite poslovne svrhe ne morate se previše brinuti o određenim oblicima, iako oni trebaju biti konzistentni. Međutim, budite svjesni da postoji određen jezik" dijagrama toka u kojem svaki oblik ima određeno značenje (rombovi su mjesta odlučivanja, pravokutnici su koraci procesa itd.).  

 

27. Pojasnite organizacijski dijagram 

 

Kao što ime implicira, organizacijski dijagram ilustrira pozicije, jedinice ili funkcije u organizaciji i njihove odnose. Naravno, ovi dijagrami nisu ograničeni na organizacijske strukture; oni se također mogu koristiti u skiciranju poruka. 

 

 

28. Vizualni elementi imaju osobito snažan učinak na vaše čitatelje i na način na koji će percipirati vas i vaš rad, stoga je verifikacija kvalitete vaših vizualnih elemenata ključan korak. Postavite si tri pitanja o svakom vizualnom elementu. Navedite ih. 

 

    Je li vizualni element točan?  

    Je li vizualni element ispravno dokumentiran?  

    Je li vizualni element iskren?  

 

29. Vizualni elementi imaju osobito snažan učinak na vaše čitatelje i na način na koji će percipirati vas i vaš rad, stoga je verifikacija kvalitete vaših vizualnih elemenata ključan korak. Bitno pitanje vezano za vaš vizualni elemenat je „Je li vizualni element točan“? Pojasnite ovu rečenicu i njeno značenje. 

 

    Je li vizualni element točan? Svakako provjerite eventualne pogreške poput tipografskih grešaka, nekonzistentne upotrebe boje, zbunjujućih ili nedokumentiranih simbola i krivo svrstanih elemenata. Također provjerite jesu li informacije u vizualnim elementima i tekstu usklađene. Kod prezentacije podataka, osobito ako stvarate grafikone pomoću proračunske tablice, provjerite bilo kakve formule korištene u generiranju brojeva i uvjerite se da ste odabrali odgovarajuće brojeve za svaki grafikon. Kada ste u žurbi, lako je odabrati krivi stupac brojeva u proračunskoj tablici ili krivi set brojeva u stupcu. Za dijagrame toka, organizacijske dijagrame, dijagrame, fotografije i druge vizualne elemente, usporedite vizualne elemente koje ste stvorili s onima koje ste planirali napraviti. Prenosi li svaki vizualni element točno vašu poruku? Jeste li umetnuli odgovarajuće fotografije, karte ili druge dokumente?  

 

30. Vizualni elementi imaju osobito snažan učinak na vaše čitatelje i na način na koji će percipirati vas i vaš rad, stoga je verifikacija kvalitete vaših vizualnih elemenata ključan korak. Bitno pitanje vezano za vaš vizualni elemenat je „Je li vizualni element ispravno dokumentiran?“ Pojasnite ovu rečenicu i njeno značenje. 

 

 

     Je li vizualni element ispravno dokumentiran? Kao i tekstualni elementi u vašim izvještajima i prezentacijama, vizualni elementi temeljeni na tuđim istraživanjima, informacijama i idejama zahtijevaju potpuno citiranje. (Čak i ako je grafički element u potpunosti vaš, bilo kakva pozadinska informacija preuzeta iz drugog izvora mora biti dokumentirana.) Također, pokušajte predvidjeti pitanja ili interese koje bi vaša publika mogla imati i po potrebi odgovoriti na njih dodatnom informacijom. Na primjer, ukoliko predstavljate rezultate anketnog istraživanja, mnogi čitatelji će htjeti znati tko je sudjelovao u istraživanju, koliko je ljudi odgovorilo i kada su pitanja postavljana. Na ova biste pitanja mogli odgovoriti opisnom bilješkom poput ,,652 računovođa, anketirano 17. siječnja". Slično tome, ukoliko ste vizualni element pronašli u sekundarnom izvoru, navedite taj izvor na grafičkom prikazu ili u neposrednoj blizini kako biste čitateljima pomogli da procijene informaciju. Alternativna je opcija da izvore navedete u dodatku.  

 

31. Vizualni elementi imaju osobito snažan učinak na vaše čitatelje i na način na koji će percipirati vas i vaš rad, stoga je verifikacija kvalitete vaših vizualnih elemenata ključan korak. Bitno pitanje vezano za vaš vizualni elemenat je „Je li vizualni element iskren“? Pojasnite ovu rečenicu i njeno značenje. 

    Je li vizualni element iskren? Kao posljednja mjera opreza, odmaknite se na trenutak i uvjerite se da vaši vizualni elementi odašilju vjerodostojne poruke. Uvjerite se da ne skrivaju informacije koje su potrebne publici, da ne impliciraju zaključke koji nisu podržani informacijama ili da ne upravljaju emocijama vaše publike na manipulativan ili prisiljavajući način.