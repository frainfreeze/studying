...
function morechildren(e, t, n, r, i) {
    $(e).html(reddit.status_msg.loading).css("color", "red");
    var s = $(e).parents(".thing.morechildren:first").thing_id(),
        o = {
            link_id: t,
            sort: n,
            children: r,
    ...
    return $.request("morechildren", o, undefined, undefined, undefined, !1), !1
}
...
function sr_name_up(e) {
    var t = $("#sr-autocomplete").val(),
        n = window.old_sr_name || "";
...
function sr_name_down(e) {
    ...
    if (e.keyCode == 38 || e.keyCode == 40) {
        var n = e.keyCode == 38 && "up" || "down",
            r = $("#sr-drop-down .sr-selected:first"),
            i = $("#sr-drop-down .sr-name-row:first"),
            s = $("#sr-drop-down .sr-name-row:last"),
            o = null;
    ...
    if (e.keyCode == 13) return $("#sr-autocomplete").trigger("sr-changed"), hide_sr_name_list(), t.parents("form").submit(), !1
}
...
function reply(e) {
    var t = comment_reply_for_elem(e),
        n = t.find("textarea");
...
function show_friend(e) {
    var t = '<a class="friend" title="friend" href="/prefs/friends">F</a>',
        n = $("div.content .author.id-" + e).addClass("friend").next(".userattrs").each(function() {
    ...
    jQuery.event = {
        ...
        remove: function(e, t, n, r, i) {
            ...
            while (f--) {
                ...
                c = jQuery.event
                    .special[p] || {}, p = (r ? c.delegateType : c.bindType) || p, h = a[p] || [], u = u[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = h.length;
...
JSON || (JSON = {}),
    ...
    function() {
        ...
        var C = x.some = x.any = function(e, t, r) {
            t || (t = x.identity);
            var i = !1;
            return e == null ? i : g && e.some === g ? e.some(t, r) : (T(e, function(
                e, s, o) {
                if (i || (i = t.call(r, e, s, o))) return n
            }), !!i)
        };
    ...
    function e(t, n, r) {
        ...
        1: [function(e, t, n) {
            ...
            function i(e) {
                ...
                for (var r = 0; r < e; r++) t.push(n.charAt(Math.floor(Math.random() * n.length)));
                return t.join("")
            }
            ...
            function o(e, t, n) {
                document.cookie = e + "=" + t + "; expires=" + n.toGMTString() + ";"
            }

            function u() {
                if (window.reddit && window.reddit.logged) return {};
                var e = s("loid", "loidcreated");
                if (e.loid) return e;
                var t = i(18),
                    n = (new Date).toISOString(),
                    r = new Date;
                return r.setFullYear(r.getFullYear() + 2), o("loid", t, r), o("loidcreated", n, r), s("loid", "loidcreated")
            }
    ...
    function(e) {
        ...
        try {
            r.setupBackbone(), r.login.ui.init(), r.analytics.init(), r.ui.init(), r.interestbar.init(), r.visited.init(), r.apps.init(), r.wiki.init(), r.gold.init(), r.multi.init(), r.recommend.init(), r.saved.init(), r.messages.init(), r.resAdvisory.init(), r.filter.init(), r.newsletter.ui.init()
        } catch (e) {
        ...
        e.fn.init = function(t, s, o) {
            ...
            if (t && typeof t == "string" && !e.isPlainObject(s) && (u = i.exec(e.trim(t))) && u[0]) {
                ...
                if (e.parseHTML) return r.call(this, e.parseHTML(t, s, !0), s, o)
            }
        ...
        _summarize: function() {
            this.$el.addClass("summarized"), this.$hiddenItems.hide(), this.$toggleButton.text(r._("… and %(count)s more ⇒").format({
                count: this.$hiddenItems.length
            }))
        },
        _expand: function() {
            this.$el.removeClass("summarized"), this.$hiddenItems.show(), this.$toggleButton.text(r._("⇐ less"))
        },
        _toggle: function(e) {
        ...
        init: function() {
            ...
            }, this)), $(".promotedlink.promoted:visible").trigger("onshow"), r.analytics.addEventPredicate("ads", function() {
                return !r.config.is_sponsor
            }), r.config.ads_virtual_page && r.analytics.fireFunnelEvent("ads", r.config.ads_virtual_page)
        },
        _eventPredicates: {},
        ...
        fireFunnelEvent: function(e, t, n, r) {
            ...
            if (n.tracker && "_ga" in window && window._ga.getByName(n.tracker)) {
        ...
        fireTrackingPixel: function(e) {
            var t = $(e),
                n = $("body").hasClass("comments-page");
            if (t.data("trackerFired") || n) return;
            var r = $("#siteTable_organic").is(":hidden"),
                i = new Image,
                s = t.data("impPixel");
            s && !r && (i.src = s);
            if (!r) {
                var o = t.data("thirdPartyTrackingUrl");
                if (o) {
                    var u = new Image;
                    u.src = o
                }
                var a = t.data("thirdPartyTrackingTwoUrl");
                if (a) {
                    var f = new Image;
                    f.src = a
                }
            ...
            var l = new Image,
                c = t.data("adserverImpPixel"),
                h = t.data("adserverClickUrl");
            c && !r && (l.src = c), t.data("trackerFired", !0)
        },
    ...
    function(e) {
        ...
        e.log = function(e) {
                ...
                if (e.with_default(reddit.debug, !1)) return e.log(t)
            }, e.fn.debug = function() {
        ...
        e.request = function(t, o, u, a, f, l, c) {
            ...
            if (window != window.top && !reddit.external_frame) return;
        ...
        rate_limit = function() {
            ...
            if (reddit.logged && e(this).hasClass("arrow")) {
                var s = e(this).hasClass(o) ? 1 : e(this).hasClass(a) ? -1 : 0,
                    l = e(this).all_things_by_id(),
                    c = l.children().not(".child").find(".arrow"),
                    h = s == 1 ? o : u,
                    p = s == 1 ? u : o;
        ...
        e.fn.set_thing_init = function(t) {
            ...
            return e && t.attr("src", "/captcha/" + e + ".png").siblings('input[name="iden"]').val(e), t
            ...
            var r = "applied_subreddit_stylesheet",
                i = e('link[title="' + r + '"]');
            i.length == 0 && (e("head").append('<link type="text/css" title="' + r + '" rel="stylesheet">'), i = e('link[title="' + r + '"]')), i.attr("href", t), e("#sr_style_enabled").prop("checked", n), e("#sr_style_throbber").html("").css("display", "none")
        ...
        _.extend(p.prototype, {
            ...
            showMessage: function(n) {
                ...
                s.on("focus.c.stateify", function() {
                    s.parents("form").find(r).not(o).tooltip("hide");
                    var e = o.data("bs.tooltip");
                    e && e.tip().off("bsTransitionEnd"), o.tooltip("show")
    ...
    function(e) {
        ...
        function a(e, t) {
            return e && t.indexOf(e) !== -1 || _.any(n, function(e) {
                return e.test(t)
            })
        }
        ...
        function d(e, t) {
            return e = e || "", t = t || "", a(e, t) ? 0 : _.reduce(h, function(e, n) {
                return e += p(t, n)
            }, 0)
        }
        ...
        _.extend(t.prototype, {
            ...
            initialize: function(n, r) {
                ...
                var i = this.$el = e(n),
                    s = this.$username = e(this.options.username),
                    o = this.$meter = e(this.options.template),
                    u = this.options.trigger;
                u !== "manual" && i.on(this.options.trigger, _.debounce(this.score.bind(this), this.options.delay)), o.insertAfter(i);
                var a = o.outerWidth(),
                    f = a + 5 + "px";
                return i.css({
                    "padding-right": f
            ...
            score: function() {
                var e = this.$el.val(),
                    t = this.$username.val(),
                    n = d(t, e),
                    r = Math.min(100, Math.max(this.options.minimumDisplay, n));
                this.$el.trigger("score.strengthMeter", r), this._cancelScore || this.$meter.find(".strength-meter-fill").css({
                    width: r + "%"
                }), this._cancelScore = !1
            },
...
var toolbar_p = function(e, t) {
    ...
    this.comments_pushed = function(e) {
        ...
        var n = $(e).find('input[type="text"]').val(),
            r = t + escape(n);
...
$(function() {
    ...
    $("body").click(close_menus), $("body").set_thing_init(updateEventHandlers), "placeholder" in document.createElement("input") || $("textarea[placeholder], input[placeholder]").addClass("gray").each(function() {
    ...
    }), $('#searchexpando input[name="restrict_sr"]').prop("checked", !!store.get("search.restrict_sr.checked")), $("#search_showmore").click(function(e) {
        ...
        return $("#sr_style_throbber").html('<img src="' + r.utils.staticURL("throbber.gif") + '" />').css("display", "inline-block"), post_form($(this).parent(), "set_sr_style_enabled")
    }), $(".reddit-themes .theme").click(function() {
        $("div.theme.selected").removeClass("selected"), $("input[name='enable_default_themes']").prop("checked", !0), $(this).hasClass("select-custom-theme") ? $("#other_theme_selector").prop("checked", !0) : $("input[name='theme_selector'][value='" + $(this).attr("id") + "']").prop("checked", !0), $(this).addClass("selected")
    ...
    e.spotlight = {
        setup: function(i, s, o, u) {
            this.organics = [], this.lineup = [], this.interestProb = s, this.showPromo = o, this.srnames = u, this.lastPromoTimestamp = Date.now(), this.MIN_PROMO_TIME = 1500, this.next = this._advance.bind(this, 1), this.prev = this._advance.bind(this, -1), this.$listing = n(".organic-listing");
            var a = n("#siteTable_organic").is(":hidden");
            a && (this.showPromo = !1), i.forEach(function(e) {
                this.organics.push(e), this.lineup.push({
                    fullname: e
                })
            }, this), s && this.lineup.push(".interestbar");
            if (!this.$listing.length) return;
            this.$listing.find(".arrow.prev").on("click", this.prev), this.$listing.find(".arrow.next").on("click", this.next);
            var f, l = e.analytics.breadcrumbs.lastClickFullname(),
                c = n(l ? ".id-" + l : null);
            c.length && this.$listing.has(c).length ? (e.debug("restoring spotlight selection to last click"), f = {
                fullname: l
            }) : f = this.chooseRandom(), this.lineup = t.chain(this.lineup).reject(function(e) {
                return t.isEqual(f, e)
            }).shuffle().unshift(f).value(), this.lineup.pos = 0, this._advance(0), "hidden" in document ? (this.readyForNewPromo = !document.hidden, n(document).on("visibilitychange", function(e) {
                !document.hidden && this.showPromo && this.requestNewPromo()
            }.bind(this))) : (this.readyForNewPromo = document.hasFocus() && this.showPromo, n(window).on("focus", this.requestNewPromo.bind(this)))
        },
        requestNewPromo: function() {
            if (!this.readyForNewPromo) {
                this.readyForNewPromo = !0;
                return
            }
            if (!this.lineup[this.lineup.pos].promise) return;
            var e = this.$listing.find(".promotedlink"),
                t = e.next(".clearleft");
            if (!e.length || e.is(":hidden") || e.offset().top < window.scrollY || Date.now() - this.lastPromoTimestamp < this.MIN_PROMO_TIME) return;
            var n = this.requestPromo();
            n.then(function(r) {
                if (!r || !r.length) return;
                var i = r.eq(0),
                    s = i.data("fullname");
                this.organics[this.lineup.pos] = s, this.lineup[this.lineup.pos] = n, e.add(t).remove(), r.show(), this.$listing.hide().show()
            }.bind(this))
        },
        requestPromo: function() {
            return n.ajax({
                ...
                if (e) {
                    this.showPromo && n("#siteTable_organic").show("slow"), this.lastPromoTimestamp = Date.now();
                    var r = n(e);
                    return r.hide().appendTo(this.$listing), r
                }
                return !t.length && !this.organics.length && n("#siteTable_organic").hide(), !1
            }.bind(this))
        },
        chooseRandom: function() {
            if (this.showPromo) return this.requestPromo();
            if (Math.random() < this.interestProb) return ".interestbar";
            var e = this.organics[Math.floor(Math.random() * this.organics.length)];
            return e ? {
                fullname: e
            } : null
        },
        _materialize: function(t) {
            ...
            var i;
            typeof t == "string" ? i = t : t.campaign ? i = '[data-cid="' + t.campaign + '"]' : i = '[data-fullname="' + t.fullname + '"]';
        ...
        _advance: function(e) {
            var t = this.$listing.find(".nextprev"),
                ...
                o = setTimeout(function() {
                    t.toggleClass("working", s.state && s.state() == "pending")
                }, 200);
            this.lineup.pos = i;
            var u = n.when(s);
            u.always(function(n) {
                ...
                t.removeClass("working"), this.$listing.removeClass("loading");
                if (n) {
                    var s = n.css("background-color");
                    s && this.$listing.css("background-color", s)
                }
                r.hide(), n.show(), this.help(n), this.lineup.pos != 0 && (this._materializePos(this._advancePos(1)), this._materializePos(this._advancePos(-1)))
            }.bind(this))
        },
        help: function(e) {
            var t = n("#spotlight-help");
            if (!t.length) return;
            n(function() {
    ...
    e = e.originalEvent;
    if (e.origin != r.adzerk.origin) return;
